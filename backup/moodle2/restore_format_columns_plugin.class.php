...
class restore_format_columns_plugin extends restore_format_plugin {
    ...
    protected function define_course_plugin_structure() {
        ...
        /* This is defines the nested tag within 'plugin_format_columns_course' to allow '/course/plugin_format_columns_course'
           in the path therefore as a path structure representing the levels in course.xml in the backup file. */
    ...
    /**
     * Process the 'plugin_format_columns_course' element within the 'course' element in the 'course.xml' file in the '/course'
